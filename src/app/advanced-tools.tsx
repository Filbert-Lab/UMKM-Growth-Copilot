...
export function AdvancedTools({
  ...
  return (
    <div className="mt-6 space-y-4">
      ...
      <section className="tool-card reveal" style={{ animationDelay: '0ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
            KPI Generator
          </h4>
          <button
            type="button"
      ...
      <section className="tool-card reveal" style={{ animationDelay: '100ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
            Campaign Planner
          </h4>
          <button
            type="button"
      ...
      <section className="tool-card reveal" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
            Break-Even Analyzer
          </h4>
        </div>
      ...
      <section className="tool-card reveal" style={{ animationDelay: '300ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"></rect><path d="M7 15h0M2 9.5h20"></path></svg>
            Cashflow Alert
          </h4>
        </div>
        <div className="tool-grid-3">
      ...
      <section className="tool-card reveal" style={{ animationDelay: '400ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>
      ...
      <section className="tool-card reveal" style={{ animationDelay: '500ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
      ...
      <section className="tool-card reveal" style={{ animationDelay: '600ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
            Content Calendar AI
          </h4>
          <button
            type="button"
      ...
      <section className="tool-card reveal" style={{ animationDelay: '700ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
      ...
      <section className="tool-card reveal" style={{ animationDelay: '800ms', animationFillMode: 'both' }}>
        <div className="tool-head">
          <h4>
            <svg className="w-4 h-4 text-[#d57852]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
